...
class MessageRetryService {
    ...
    private func processRetryQueue() {
        ...
        for message in messagesToRetry {
            ...
            // 注释掉 viewModel?.connectedPeers 相关逻辑
            let viewModel = meshService.delegate as? BitchatDelegate
            ...
            if message.isPrivate {
                ...
                if let recipientID = message.recipientPeerID,
                   ...
                   true { // Assuming recipient is always connected for now
                ...
                if true { // Assuming peers are always connected for now
